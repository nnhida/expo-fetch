...
interface homeProps{
    beritaList: beritaProps[] | undefined
    kegiatanList: kegiatanProps[] | undefined
}

export default function Ui({beritaList, kegiatanList}:homeProps) {
  return (
    <main className="">
      <section id="beranda" className="h-screen flex">
      ...
      <section id="tentangKita" className=" p-10 lg:p-24 flex items-center">
        <div className="flex flex-col lg:flex-row lg:items-end space-y-10 lg:space-y-0 justify-evenly">
          <div className=" bg-emerald-600 lg:pt-10">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/042/057/892/small_2x/ai-generated-female-teacher-with-eyeglasses-isolated-on-transparent-background-png.png" alt="about image" className= "w-full lg:w-[450px]"/>
          </div>
      ...
      <section id="kegiatan" className="p-10 lg:p-24 flex flex-col space-y-10">
        ...
        <div className="flex flex-col lg:flex-row space-y-10 lg:space-x-5 lg:space-y-0 items-center ">
          {kegiatanList !== undefined && kegiatanList.map((item) =>(
            <EventSchool url={item.image} title={item.title} desc={item.desc}/>
          ))}
      ...
      <section id="berita" className="p-10 lg:p-24 flex flex-col space-y-10">
        ...
        <div className="overflow-x-auto">
          <div className="flex lg:w-full w-max space-x-5">
            {beritaList !== undefined && beritaList.map((item) =>(
              <EventSchool url={item.image} title={item.title} desc={item.desc}/>
            ))}
          </div>
        </div>
